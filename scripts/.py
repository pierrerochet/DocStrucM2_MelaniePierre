...
def main(input_path=f".{os.sep}data{os.sep}steam-store-games", 
         output_path=f".{os.sep}data{os.sep}data.csv"):
    
    # load datasets
    df_desc = pd.read_csv(input_path + f"{os.sep}steam_description_data.csv")
    df_media = pd.read_csv(input_path + f"{os.sep}steam_media_data.csv")
    df_req = pd.read_csv(input_path + f"{os.sep}steam_requirements_data.csv")
    df = pd.read_csv(input_path + f"{os.sep}steam.csv")
    df_tag = pd.read_csv(input_path + f"{os.sep}steamspy_tag_data.csv")
